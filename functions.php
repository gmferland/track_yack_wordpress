...
function trackyack_scripts() {
  wp_enqueue_style( 'app', get_template_directory_uri() . '/build/app.373681c197556cdf56d0.css');
  ...
  wp_enqueue_script( 'app', get_template_directory_uri() . '/build/app.2fba19e4109f7f875c9c.js', array(), false, true );

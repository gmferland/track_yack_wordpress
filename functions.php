...
function trackyack_scripts() {
	wp_enqueue_style( 'app', get_template_directory_uri() . '/build/app.3247a06df20636bf8742.css');
  wp_enqueue_style( 'vendor', get_template_directory_uri() . '/build/vendor.3247a06df20636bf8742.css' );
  wp_enqueue_script( 'app', get_template_directory_uri() . '/build/app.cb5c5a37e00d1379cf2e.js', array(), false, true );
  wp_enqueue_script( 'vendor', get_template_directory_uri() . '/build/vendor.1e0f0dd459308c1622d3.js', array( 'jquery' ), false, true );
}
